...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    'pointer shadow-3xl rounded-3xl border-2 border-white bg-red-800  font-bold text-white shadow-2xl shadow-red-900';
  ...
  const styles = {
    ...
    round2: base2 + ' px-2.5 py-1 md:px-3.5 md:py-2.5 text-xs',
  };
